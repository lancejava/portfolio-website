    ...
    return (
        <div name='home' className='w-full h-screen px-4 bg-[#0a192f]'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                <p className='text-[#600000] '>Hi, my name is</p>
                ...
                <div>
                    <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#600000] hover:border-[#600000]'>View Work
