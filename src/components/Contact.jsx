  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST'action='https://getform.io/f/03a74723-9bb0-4382-9932-cec321ddf88c' className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 text-gray-300 border-[#600000]'>Contact</p>
            ...
            <button className='text-white border-2 hover:bg-[#600000] hover:border-[#600000] px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate!</button>
        </form>
    </div>
  )
}
