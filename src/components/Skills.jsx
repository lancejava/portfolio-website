...
const Skills = () => {
  return (
    <div name='skills' className='bg-[#0F0E11] text-gray-300 w-full h-screen'>
        {/* Container */}
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            <div className='text-center'>
                <p className='text-4xl font-bold inline border-b-4 border-[#2B2D35]'>  Skills  </p>       
            </div>
            <div className='text-center'> 
                <p className='py-4'>// These are the technologies I've worked with</p>
            </div>
            <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
                <div className='shadow-md shadow-[#2B2D35] hover:scale-110 duration-500'>
